export class Start extends Phaser.Scene {
    ...
    preload() {
        this.load.image('background_start', 'assets/backgrounds/background_test1.png');
    ...
    create() {
        ...
        this.background_start = this.add.tileSprite(0, 0, 0, 0, 'background_start').setOrigin(0).setInteractive({useHandCursor:true});
